...
@IonicPage()
@Component({
  selector: 'page-sc6sophitia',
  templateUrl: 'sc6sophitia.html',
})
export class Sc6sophitiaPage {
    ...
    for(let i = 0; i < comArr.length; i++){
      ...
      for(let j = 0; j < elString.length; j++){
        ...
        switch(alphaNum){
         ...
         // Special Stances
          case "[": // Angel Step
            newImg.setAttribute("src", "assets/imgs/input/SophitiaAngelStep.png");
            break;

          case "]": // Angel Side Step
            newImg.setAttribute("src", "assets/imgs/input/SophitiaAngelSideStep.png");
            break;
