...
export class MoveService{
  ...
  Azwel = [
    // Reversal Edge Attacks
    [
      new Move("Director of Fate", "B+G", "MMM", 66, null, null, null, "10,10,20(40)", "Shifts to clash upon hit", false, false, false, false, true),
      new Move("Director of Fate", "b+g", "MMM", 46, null, null, null, "10,10,30(50)", "Shifts to clash upon hit or guard", false, false, false, false, true, false, false, true),
      ...
      new Move("Nebulous Critique", "rBB", "MMMMM", null, null, null, null, "27,5,4,4,8(49)", "Shifts to clash upon guard/Switches to Almighty mode"),
      new Move("Disillusionment", "rK", null, null, null, null, null, null, "Dodges opponent's attack", true)
    ],
    // Gauge Attacks
    [
      new Move("From Science, with Love", "A+B+K", "M", 18, -20, "KND", "KND", "20,6,6,6,45(85)", "SG / AT", false, false, false, false, false, false, true, false, false, false, true),
      new Move("Soul Charge", "4A+B+G", "m", null, null, null, null, "SG / BA", null, false, false, false, false, false, false, false, true, false, false, true),
      new Move("I Shall Save Humanity!", "S6A+B+K", "MMMM", 28, -30, "KND", "KND", "11,5,5,8,21,10,1×70(140)", "SG / AT", false, false, false, false, false, true, true, false, false, false, true),
      new Move("Road to Redemption", "SAAA", "HHMMMMMM", 10, 3, "LNC", "LNC", "13,13,11,5,5,6,11(26,44) ", "Switches to Almighty mode", false, false, false, false, false, true, false, true),
      new Move("Epistemophilia", "SBBB", "MMMMMM", null, null, "STN", null, "13,13,15,8,9,18(26,51)", "Switches to Almighty mode", false, false, false, false, false, true, false, true),
      new Move("Vile Academia", "S6A+B", "MMMM", 32, 4, "STN", "STN", "15,8,9,18(51)", "Switches to Almighty mode", false, false, false, false, false, true, false, true),
      new Move("Defiler's Choice", "S8A+B", "MMMM", 38, -10, "KND", "KND", "15,8,9,18(51)", "BA / TA", false, false, false, false, false, true),
      new Move("New World Revolution", "SeA+B", "MMMMMM", 30, "N/A", "SLNC", "SLNC", "11,5,5,6,11(44)", "Switches to Almighty mode", false, true, false, false, false, true, false, true)
    ],
    // Horizontal Moves
    [
      new Move("Pilgrimage of Anthropos", "A", "H", 10, -8, -2, -2, "12", "Sword", false, false, false, false, false, false, false, false, false, true),
      new Move("Pilgrimage of Anthropos", "AA", "HH", 10, -6, 0, 0, "12,12(24)", "NC / Sword", false, false, false, false, false, false, false, false, false, true),
      new Move("Pilgrimage of Anthropos", "AAA", "HHMMMMMM", 10, -10, 6, 6, "12,12,10,5,5,5,5,10(24,40)", "1st 2 hits and last 6 hits NC / TJ / ~Almighty Mode",  false, false, false, false, false, false, false, false, false, true),
      new Move("Tragedy of Humanity", "AB", "HM", 10, -20, "LNC", "LNC", "12,22(34)", "NC / Sword ~ Ax"),
      new Move("Light in the Dark", "6AA", "HH", 18, -2, 6, 6, "16,24(40)", "TC[9-26] / Ax"),
      new Move("Forbidden Path", "3A", "M", 20, -8, 4, "STUN", "20"),
      new Move("Heretic's Sweep", "2A", "SS", 14, -10, 2, 2, "8,8(16)", "NC / TC[8~] / ~FC / Sword", true, false, true),
      new Move("Heretic's Sweep ~ Beauty of Balance", "2AK", "SS", 14, -2, 10, 10, "8,8(16)", "SS/ TC[8-?] / Sword", true),
      new Move("Heretic's Sweep ~ Tragedy of War", "2A6K", "SS", 14, null, null, null, "8,8(16)", "SS / TC[8-?] / Sword ~ Ax", true),
      new Move("Heretic's Sweep ~ Comedy of Errors", "2A4K", "SS", 14, null, null, null, "8,8(16)", "SS/ TC[8-?] / Sword ~ Spear", true),
      ...
      new Move("Heretic's Sweep", "CA", "SS", 14, -10, 2, 2, "8,8(16)", "NC / TC[8~] / ~FC / Sword", false, false, true),
      new Move("Heretic's Sweep ~ Beauty of Balance", "CAK", "SS", 14, null, null, null, "8,8(16)", null, true),
      new Move("Heretic's Sweep ~ Tragedy of War", "CA6K", "SS", 14, null, null, null, "8,8(16)", null, true),
      new Move("Heretic's Sweep ~ Comedy of Errors", "CA4K", "SS", 14, null, null, null, "8,8(16)", null, true),
      new Move("Impulse Pincer", "C3A", "HH", 18, 0, "KND", "KND", "KND", "16,24(40)", "NC / Ax", true, null, null, null, null, null, null, null, null),
      ...
      new Move("Radical Liberty", "8A", "M", 26, -2, 2, 2, "N/A", "TJ[8-32] / Opp. ~BT (hit) / Sword"),
      new Move("Thorough Inquest", "7A", "L", 40, -18, 4, 4, "N/A", "TJ[13-?] / ~FC / Spear", false, false, true),
    ...
    [
      ...
      new Move("Heart on Trial", "BA", "MH", 14, -2, "KND", "KND", "12,30", "Sword ~ Ax", false, false, false, false, false, false, false, false, false, true),
      new Move("Seven Sages' Aphorism", "BB", "MM", 14, -8, 0, 0, "12,12(24)", "NC / Sword"),
      new Move("Seven Sages' Aphorism", "BBB", "MMMMMM", 14, -6, "STN", "STN", "12,12,14,8,8,16(24,47)", "First 2 and last 4 hits NC / TJ / Sword ~ Almighty", "Switches to Almighty mode"),
      new Move("Seven Sages' Aphorism ~ Beauty of Balance", "BBK", "MM", 14, -12, null, null, "12,12(24)", "SS / NC / Sword", true),
      new Move("Seven Sages' Aphorism ~ Tragedy of War", "BB6K", "MM", 14, null, null, null, "12,12(24)", "SS / NC / TC / Sword ~ Ax", true),
      new Move("Seven Sages' Aphorism ~ Comedy of Errors", "BB4K", "MM", 14, null, null, null, "12,12(24)", "SS / Sword ~ Spear", true),
...
"),
      ...
      new Move("Path to Glory", "2BB", "MM", 16, -14, 8, 8, "12,14(26)", "NC / Sword"),
      new Move("Path to Glory ~ Beaty of Balance", "2BBK", "MM", 16, -6, null, null, "12,14(26)", "SS / TC / Sword", true),
      new Move("Path to Glory ~ Tragedy of War", "2BB6K", "MM", 16, null, null, null, "12,14(26)", "SS / TC / Sword ~ Ax", true),
      new Move("Path to Glory ~ Comedy of Errors", "2BB4K", "MM", 16, null, null, null, "12,14(26)", "SS / Sword / Spear", true),
      new Move("Save the Betrayed", "1B", "L", 18, -16, -4, -4, "16", "GI[L 11-24]/ SS on GI / TC[23-?] / Spear", true),
      new Move("Save the Betrayed", "1BB", "LH", 18, -8, 8, 8, "16,24", "GI vs. low", false, false, false, true),
      ...
      new Move("Coup D'etat", "C3BB", "MM", 16, -8, "KND", "KND", "22,26(41)"),
      new Move("Talon Spear", "C1B", "M", 12, -14, "LNC", "LNC", "24", "Sword"),
      new Move("Enlightenment", "CB", "M", 14, -8, 2, 2, 16, "Sword"),
      new Move("Enlightenment", "CBB", "MM", 14, -12, 4, 4, "16,20(36)", "NC / Can be delayed / Sword"),
