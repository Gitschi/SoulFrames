...
export class MoveService{
  Mitsurugi = [
    ...
    [
      ...
      new Move("Dawn Breath ~Mist", "4A6", "H, SS", 19, -2, 6, 6, 28, null, true),
    ...
    [
      ...
      new Move("Forced Prayer Divide ~Mist", "BB6", "M,M", 15, -10, null, null, 34, null, true),
      ...
      new Move("Wind Hole Vortex ~Mist", "4B6", "SS", null, null, null, null, null, null, true),
    ...
    [
      ...
      new Move("Stalk Shaver ~Mist", "2KB6", "L,M,SS", 17, -22, -10, "KND", 48, null, true),
    ...
    [
      ...
      new Move("Blunt Flames ~Mist", "!|uBA6", "M,H,SS", 19, -8, 4, 4, 55, null, true),
      new Move("Hell Divide", "$B", "M", 30, -8, "KND", "STN", 18),
      new Move("Hell Divide ~Mist", "$B6", "M,SS", 30, -5, "KND", "STN", 18, "", true),
    ...
    [
      [
        new Move("Silent Step", "236", "SS", null, null, null, null, null, null, true),
      ...
      [
        new Move("Mist", "4|6B+K", "SS", null, null, null, null, null, null, true),
        new Move("Mist", "$|^B+K", "SS", null, null, null, null, null, null, true),
